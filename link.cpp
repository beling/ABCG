...
: A(A), B(B), maxDeltaLength(maxDeltaLength) {
    length = originalLength = A.pos.distans(B.pos); //d�ugo��
    deltaLength = 0.0;
...
//nie zmienia� masy node w destruktorze i konstruktorze bo s� one wywo�ywane w do�� przypadkowych momentach w programie!!!
