...
///Czy rysowa� siatk� w trybie edycji?
bool grid = true;

int current_level_id = 0;

enum Mode {
	m_anim, m_pause, m_edit //czy jeste�my w trybie: 0-animacji, 1-znimacji (pause), 2-edycji
} mode = m_edit;

vec2d<double> linkStart(NAN, NAN), linkEnd(NAN, NAN); //je�li rysujemy link to wyznacza jego wsp.
